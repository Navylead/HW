...
select name имя, email from students;

--Вывести id, имя, email и дату создания пользователей
select id, name имя, email, created_on "дата создания пользователей" from students;
...
select name from students where created_on = '2021-03-26 00:00';
...
select name from students where id < 127
or id > 188;
...
select id, name имя, created_on "дата создания пользователя" from students order by created_on asc;

--Вывести id пользователя, имя, дату создания пользователя. Отсортировать по порядку убывания даты добавления пользоватлеля.
select id, name имя, created_on "дата создания пользователя" from students order by created_on desc;
